...
function Podium({ standings, event }) {
    ...
    first = event?.status === "Completed" ? standings[0] ?? null : null;
    second = event?.status === "Completed" ? standings[1] ?? null : null;
    third = event?.status === "Completed" ? standings[2] ?? null : null;
